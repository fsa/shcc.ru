...
<p>Исходные коды альфа версии проекта: <a href="https://github.com/fsa/neohome">https://github.com/fsa/neohome</a>. Это основной репозиторий проекта. Ветка alpha - текущая версия проекта, ветка master - релизы (в настоящий момент отсутствуют).</p>
<p>Ранняя версия проекта: <a href="https://github.com/fsa/phpmd">https://github.com/fsa/phpmd</a>. Используется автором для автоматизации своего &laquo;умного дома&raquo; (до выпуска релиза Neohome).</p>
</body>
</html>
