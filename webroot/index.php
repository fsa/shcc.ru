...
<ul>
    <li>ОС Linux с системой инициализации systemd, например, Ubuntu 20.04 LTS или новее.</li>
</ul>
<p>Для работы с панелью управления необходим браузер с поддержкой ECMAScript 6 (любая современная версия баузеров, в том числе Google Chrome, Firefox).</p>
